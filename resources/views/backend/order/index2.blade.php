          ...
          <tbody>
            ...
            @endphp
                <tr>
                    ...
                    <td>@foreach($shipping_charge as $data) RWF {{number_format($data,2)}} @endforeach</td>
                    ...
                    <td>
                        ...
                        <a href="{{route('order.edit',$order->id)}}" class="text-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
