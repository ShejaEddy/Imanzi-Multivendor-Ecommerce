          ...
          <tbody>
            @foreach($orders as $order)
                <tr>
                    ...
                    <td>
                        <a href="{{route('order.show',$order->id)}}" class="text-warning btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="view" data-placement="bottom"><i class="fas fa-eye"></i></a>
                    </td>
                </tr>
            @endforeach
          </tbody>
