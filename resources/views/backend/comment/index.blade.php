...
@section('main-content')
 ...
 <div class="card shadow-sm mb-4">
     ...
     <div class="card-header py-3">
        <h4 class=" font-weight-bold">Comments list</h4>
        <ul class="breadcrumbs">
            <li><a href="{{route('admin')}}" style="color:#999">Dashboard</a></li>
            <li><a href="" class="active text-primary">Comments</a></li>
        </ul>
      </div>
    <div class="card-body">
            ...
            {{-- {{$comment}}   --}}
              ...
              @endphp
                <tr>
                    ...
                    <td>
                        <a href="{{route('comment.edit',$comment->id)}}" class="text-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
