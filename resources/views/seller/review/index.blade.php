            ...
            @foreach($reviews as $review)
              ...
              @endphp
                <tr>
                    ...
                    {{-- <td>
                        <a href="{{route('seller.review.show',$order->id)}}" class="btn btn-warning btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="view" data-placement="bottom"><i class="fas fa-eye"></i></a>
