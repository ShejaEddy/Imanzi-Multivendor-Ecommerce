...
<div class="card">
    <h5 class="card-header text-primary">Edit Coupon</h5>
    <div class="card-body">
      <form method="post" action="{{route('coupon.update',$coupon->id)}}" class="col-sm-12 col-md-4">
        @csrf
        @method('PATCH')
        <div class="form-group">
          ...
          <div class="form-group">
              ...
              <select name="type" class="form-control">
                  <option value="fixed" {{(($coupon->type=='fixed') ? 'selected' : '')}}>Fixed (RWF)</option>
