          ...
          <tbody>
            @foreach($orders as $cart)
                <tr>
                    ...
                    <td>
                        {{-- <a href="{{route('order.show',$cart->order->id)}}" class="btn btn-warning btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="view" data-placement="bottom"><i class="fas fa-eye"></i></a> --}}
