...
@section('main-content')
 ...
 <div class="card shadow-sm mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Deal Lists</h6>
      <a href="{{route('deal.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add Deal"><i class="fas fa-plus"></i> Add Deal</a>
    </div>
    <div class="card-body">
