        ...
        <div class="card border-left-success shadow-sm h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Approved Products</div>
                <div class="h5 mb-0 font-weight-bold text-gray-800">{{\App\Models\Product::countProductApprovalStatus('approved')}}</div>
              </div>
              <div class="col-auto">
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-gray-800">{{\App\Models\Product::countProductApprovalStatus('pending')}}</div>
              </div>
              <div class="col-auto">
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-gray-800">{{\App\Models\Product::countProductApprovalStatus('denied')}}</div>
              </div>
              <div class="col-auto">
      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-primary shadow-sm h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Delivered Orders</div>
                <div class="h5 mb-0 font-weight-bold text-gray-800">{{\App\Models\SellerOrder::countOrders()}}</div>
              </div>
              <div class="col-auto">
    ...
    <div class="row">
      ...
      <div class="col-xl-4 col-lg-5">
        <div class="card shadow-sm mb-4">
          <!-- Card Header - Dropdown -->
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Client Orders</h6>
          </div>
          <!-- Card Body -->
...
<script type="text/javascript">
  ...
  function drawChart()
  {
      ...
      var options = {
          title : 'Last 7 Days ordered products'
      };
  ...
  {{-- line chart --}}
  <script type="text/javascript">
    const url = "{{route('seller.product.order.income')}}";
