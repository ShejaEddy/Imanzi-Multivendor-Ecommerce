            ...
            @foreach($reviews as $review)
              ...
              @endphp
                <tr>
                    ...
                    <td>
                        <a href="{{route('user.productreview.edit',$review->id)}}" class="text-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
