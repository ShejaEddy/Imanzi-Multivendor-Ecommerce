...
<style type="text/css">
  ...
  <section class="order_details pt-3">
    ...
    <table class="table table-stripped table-stripe">
      <thead>
        <tr>
      ...
      @endphp
        <tr>
          ...
          <td><span>Rwf{{number_format($cart->price,2)}}</span></td>
        </tr>
      @endforeach
      </tbody>
      <tfoot>
        <tr>
          ...
          <th scope="col"> <span>Rwf{{number_format($order->sub_total,2)}}</span></th>
        </tr>
      ...
      @endif --}}
        <tr>
          ...
          <th><span>Rwf{{number_format($order->delivery_charge,2)}}</span></th>
        </tr>
        <tr>
          <th scope="col" class="empty"></th>
          ...
          <th>
            <span>
                Rwf{{number_format($order->total_amount,2)}}
            </span>
          </th>
        </tr>
      </tfoot>
